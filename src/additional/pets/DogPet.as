...
//                changeTexture("Layer 3",                                 "kakao_cat_сlosed_eyes_small", _armature);
                ...
                changeTexture("Orange_second_L_leg_small_back.png",      "Pink_second_L_leg_big_back", _armatureBack);
                changeTexture("Orange_second_R_leg_small_back.png",      "Pink_second_R_leg_big_back", _armatureBack);
                changeTexture("Orange_tail-end_small_back.png",          "Pink_tail-end_big_back", _armatureBack);
                break;
            case 7: // red_dog_big
...
//                changeTexture("Layer 3",                                 "kakao_cat_сlosed_eyes_small", _armature);
                ...
                changeTexture("Orange_second_L_leg_small_back.png",      "Orange_second_L_leg_big_back", _armatureBack);
                changeTexture("Orange_second_R_leg_small_back.png",      "Orange_second_R_leg_big_back", _armatureBack);
                changeTexture("Orange_tail-end_small_back.png",          "Orange_tail-end_big_back", _armatureBack);
                break;
            case 8: // grey_dog_big
                ...
                changeTexture("Orange_first_L_leg_small_front.png",      "Grey_first_L_leg_big_front_", _armature);
                changeTexture("Orange_second_L_leg_small_front.png",     "Grey_second_R_leg_front", _armature);
                changeTexture("Orange_first_R_leg_small_front.png",      "Grey_first_R_leg_front", _armature);
                changeTexture("Orange_second_R_leg_small_front.png",     "Grey_second_L_leg_front", _armature);
...
//                changeTexture("Layer 3",                                 "kakao_cat_сlosed_eyes_small", _armature);
                ...
                changeTexture("Orange_second_L_leg_small_back.png",      "Grey_second_L_leg_big_back", _armatureBack);
                changeTexture("Orange_second_R_leg_small_back.png",      "Grey_R_leg_big_back", _armatureBack);
                changeTexture("Orange_tail-end_small_back.png",          "Grey_tail-end_big_back", _armatureBack);
                break;
        }
