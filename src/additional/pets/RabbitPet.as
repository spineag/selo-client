    ...
    override protected function releaseTexture():void {
        switch (_petData.id) {
            case 5: // blue_rabbit  -> default
                ...
                changeTexture("tail-end",           "blue_rabbit_tail-end_front", _armature);
                ...
                changeTexture("Left_ear",           "blue_rabbit_left_ear_back", _armatureBack);
                changeTexture("Right_ear",          "blue_rabbit_ear_right_back", _armatureBack);
                changeTexture("eye",                "blue_rabbit_eye_left_black", _armatureBack);
            ...
            case 15: // violet_rabbit
                ...
                changeTexture("Left_ear",           "violet_rabbit_ear_left_front", _armature);
                ...
                changeTexture("tail-end",           "violet_rabbit_tail-end_front", _armature);
                changeTexture("cheek",              "violet_rabbit_cheek", _armature);
                changeTexture("cheek copy",         "violet_rabbit_cheek", _armature);
                changeTexture("eye01",              "violet_rabbit_eye_front", _armature);
                changeTexture("eye02",              "violet_rabbit_eye_front", _armature);
                changeTexture("closed_eye",         "violet_rabbit_eye_close_left_front", _armature); //
                changeTexture("Left_ear",           "violet_rabbit_ear_left_back", _armatureBack);
                changeTexture("Right_ear",          "violet_rabbit_ear_right_back", _armatureBack);
                changeTexture("eye",                "blue_rabbit_eye_left_black", _armatureBack);
                ...
                changeTexture("leg_R",              "violet_rabbit_leg_left_back", _armatureBack); //
                ...
                changeTexture("Layer 13",           "violet_rabbit_ear_right_front", _armatureBack);
                break;
            case 16: // orange_rabbit
                ...
                changeTexture("tail-end",           "orange_rabbit_tail-end_front", _armature);
                ...
                changeTexture("closed_eye",         "orange_rabbit_close_eye_left_front", _armature); //
                changeTexture("Left_ear",           "orange_rabbit_left_ear_back", _armatureBack);
                changeTexture("Right_ear",          "orange_rabbit_right_ear_back", _armatureBack);
                changeTexture("eye",                "orange_rabbit_eye_left_back", _armatureBack);
                ...
                changeTexture("Layer 13",           "orange_rabbit_ear_right_front", _armatureBack);
                break;
        }
