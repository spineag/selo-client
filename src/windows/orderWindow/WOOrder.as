...
public class WOOrder extends WindowMain{
    ...
    private var _rightBlockTimerBG:YellowBackgroundOut;
...
//        changeCatTexture(i);
    ...
    private function createRightBlock():void {
        ...
        _rightBlockBG = new YellowBackgroundOut(317, 278);
        _rightBlockBG.x = 407;
        _rightBlockBG.y = 178;
...
//                _arrItems[i].animation(delay);
    ...
    private function createRightBlockTimer():void {
        ...
        _rightBlockTimerBG = new YellowBackgroundOut(317, 278);
        _rightBlockTimerBG.filter = ManagerFilters.SHADOW_LIGHT;
        _rightBlockTimer.addChild(_rightBlockTimerBG);
        var bgIn:WhiteBackgroundIn = new WhiteBackgroundIn(280, 150);
        bgIn.x = 14;
        bgIn.y = 32;
